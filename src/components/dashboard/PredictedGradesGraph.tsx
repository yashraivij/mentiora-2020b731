...
export const PredictedGradesGraph = ({ userProgress }: PredictedGradesGraphProps) => {
  ...
  // Show paywall overlay for non-premium users
  if (!subscription.subscribed) {
    return (
      <div className="relative mb-8">
        {/* Blurred background content */}
        <div className="filter blur-sm pointer-events-none">
          <Card className="glass-effect border-2 border-gradient-to-r from-purple-500/20 via-blue-500/20 to-emerald-500/20 overflow-visible">
            <CardHeader>
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 bg-gradient-to-br from-amber-400 via-orange-500 to-red-500 rounded-2xl flex items-center justify-center shadow-2xl shadow-amber-500/25">
                  <TrendingUp className="h-6 w-6 text-white" />
                </div>
                <div>
                  <CardTitle className="text-3xl font-bold bg-gradient-to-r from-purple-600 via-blue-600 to-emerald-600 bg-clip-text text-transparent">
                    Predicted GCSE Grades
                  </CardTitle>
                  <p className="text-sm text-muted-foreground">AI-powered grade predictions</p>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-6">
                ...
                {[1,2,3,4,5,6].map((i) => (
                  <div key={i} className="relative">
                    <div className="h-40 bg-gradient-to-t from-gray-200 to-gray-100 dark:from-gray-700 dark:to-gray-600 rounded-3xl border-2 border-white/20 shadow-xl">
                      <div className="absolute inset-0 flex items-center justify-center font-black text-3xl text-gray-600 dark:text-gray-400">
                        {Math.floor(Math.random() * 9) + 1}
                      </div>
                    </div>
                    <div className="mt-4 text-center">
                      <div className="text-sm font-bold text-foreground">Subject {i}</div>
                    </div>
                  </div>
                ))}
              </div>
        ...
        {/* Paywall overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-purple-600/90 via-pink-500/90 to-red-500/90 rounded-3xl flex items-center justify-center backdrop-blur-sm">
          <Card className="w-full max-w-md mx-4 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-2 border-white/50 dark:border-slate-700/50 shadow-2xl">
            <CardHeader className="text-center pb-4">
              ...
              <CardTitle className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400 bg-clip-text text-transparent">
                🎯 See Your Future Grades!
              </CardTitle>
              <p className="text-slate-600 dark:text-slate-400 text-lg">
                Unlock AI-powered GCSE grade predictions
              </p>
            </CardHeader>
            
            <CardContent className="space-y-6">
              <p className="text-center text-slate-700 dark:text-slate-300">
                Get personalized grade forecasts based on your performance data and exam trends. See exactly where you're heading!
              </p>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-slate-600 dark:text-slate-400">Real-time grade predictions</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="flex-shrink-0 w-5 h-5 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center">
                    <Target className="h-3 w-3 text-white" />
                  </div>
                  <span className="text-sm text-slate-600 dark:text-slate-400">Track progress to Grade 9</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="flex-shrink-0 w-5 h-5 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center">
                    <Trophy className="h-3 w-3 text-white" />
                  </div>
                  <span className="text-sm text-slate-600 dark:text-slate-400">Achievement insights & tips</span>
                </div>
              </div>
