    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-foreground tracking-tight">Your Subjects</h2>
            <p className="text-sm text-muted-foreground mt-1">Track performance across Math & Reading/Writing</p>
          </div>
          <div className="flex items-center gap-3">
            ...
            <Button 
              ...
              size="sm"
              className="rounded-xl bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-primary-foreground shadow-md hover:shadow-lg transition-all duration-300 font-medium"
            >
