              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <motion.div 
                    ...
                    transition={{ delay: 0.3 }}
                    whileHover={{ scale: 1.02, y: -2 }}
                    className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl rounded-2xl p-5 border-2 border-orange-500/30 dark:border-orange-500/40 shadow-sm hover:shadow-lg hover:shadow-orange-500/20 hover:border-orange-500/50 transition-all duration-300"
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div className="p-2.5 rounded-xl bg-gradient-to-br from-orange-500/20 to-orange-600/10 border border-orange-500/20">
                          <Flame className="h-5 w-5 text-orange-500" />
                        </div>
                        <div>
                          <span className="text-xs font-semibold text-[#64748B] dark:text-gray-400 uppercase tracking-wider block">Study Streak</span>
                          <span className="text-xs text-[#94A3B8] dark:text-gray-500">{currentStreak === 1 ? "day" : "days"} in a row</span>
                        </div>
                      </div>
                      ...
                      <motion.div 
                        ...
                        animate={{ opacity: 1, scale: 1 }}
                        transition={{ delay: 0.4, type: "spring" }}
                        className="text-4xl font-bold bg-gradient-to-br from-orange-500 to-orange-600 bg-clip-text text-transparent"
                      >
                        {currentStreak}
                      </motion.div>
                    </div>
                    ...
                    {currentStreak < 7 && (
                      <div className="space-y-2 pt-3 border-t border-gray-200 dark:border-gray-700">
                        <div className="flex items-center justify-between text-xs font-medium text-[#64748B] dark:text-gray-400">
                          <span>Next reward: 500 MP</span>
                          <span className="text-orange-500 font-semibold">{7 - currentStreak} days left</span>
                        </div>
                    ...
                    {currentStreak >= 7 && (
                      <div className="flex items-center gap-2 pt-3 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <span className="text-xs font-semibold text-orange-600 dark:text-orange-400">Streak Reward Earned!</span>
                      </div>
                    )}
                  </motion.div>
                </TooltipTrigger>
