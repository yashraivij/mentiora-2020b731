...
import { BookOpen, Lightbulb, Target, Clock, Brain, AlertCircle } from "lucide-react";
...
interface PremiumNotebookEntryProps {
  entry: {
    id: string;
    subject: string;
    paper: string;
...
export const PremiumNotebookEntry = ({ entry }: PremiumNotebookEntryProps) => {
