  ...
  return (
    <Card className="mb-6 border-l-4 border-l-primary shadow-lg hover:shadow-xl transition-shadow duration-300 relative overflow-hidden">
      ...
      <CardContent className="space-y-6 relative">
        {/* What Tripped Me Up */}
        <div className={`bg-red-50 dark:bg-red-950/20 p-4 rounded-lg border border-red-200 dark:border-red-800/30 ${onUpgradeClick ? 'filter blur-sm' : ''}`}>
        ...
        {/* Fix Sentence */}
        <div className={`bg-green-50 dark:bg-green-950/20 p-4 rounded-lg border border-green-200 dark:border-green-800/30 ${onUpgradeClick ? 'filter blur-sm' : ''}`}>
        ...
        {/* Bulletproof Notes */}
        <div className={`bg-blue-50 dark:bg-blue-950/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800/30 ${onUpgradeClick ? 'filter blur-sm' : ''}`}>
        ...
        {/* Mini Example */}
        {entry.mini_example && (
          <div className={`bg-purple-50 dark:bg-purple-950/20 p-4 rounded-lg border border-purple-200 dark:border-purple-800/30 ${onUpgradeClick ? 'filter blur-sm' : ''}`}>
        ...
        {/* Keywords */}
        <div className={`bg-gray-50 dark:bg-gray-950/20 p-4 rounded-lg border border-gray-200 dark:border-gray-800/30 ${onUpgradeClick ? 'filter blur-sm' : ''}`}>
        ...
        {/* Next Step */}
        <div className={`bg-amber-50 dark:bg-amber-950/20 p-4 rounded-lg border border-amber-200 dark:border-amber-800/30 ${onUpgradeClick ? 'filter blur-sm' : ''}`}>
        ...
        {/* Premium CTA Overlay - Only show for non-premium users */}
        {onUpgradeClick && (
