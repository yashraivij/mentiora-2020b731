                  ...
                  <div className="bg-card/60 backdrop-blur-sm rounded-xl p-2 border border-border shadow-lg">
                    <div className="flex space-x-2">
                       <Button
                         ...
                         className={`px-6 py-2 rounded-lg font-medium transition-all duration-200 ${
                           flashcardView === "create" 
                             ...
                             : "hover:bg-green-100 dark:hover:bg-green-900/30 hover:text-green-700 dark:hover:text-green-300"
                         }`}
                       >
                       ...
                       <Button
                         ...
                         className={`px-6 py-2 rounded-lg font-medium transition-all duration-200 ${
                           flashcardView === "cards" 
                             ? "bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white border-0 shadow-lg" 
                                ...
                                <CardContent className="relative pt-0">
                                  <div className="grid grid-cols-2 gap-2">
                                    ...
                                    <Button
                                      ...
                                      className="w-full bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-primary-foreground shadow-sm hover:shadow-md transition-all duration-200 text-xs"
                                    >
