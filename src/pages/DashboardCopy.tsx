  ...
  useEffect(() => {
    const handleOpenPremiumPaywall = () => {
      ...
      if (!subscribed) {
        ...
        // If user is already subscribed, show manage subscription instead
        openCustomerPortal();
      }
    };
      ...
      <div className="container mx-auto px-6 py-8 max-w-7xl">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        ...
                        <span className="text-sm font-semibold bg-gradient-to-r from-emerald-600 to-green-600 dark:from-emerald-400 dark:to-green-400 bg-clip-text text-transparent">Premium Active</span>
                      </div>
                    </div>
                  </div>
                     ...
                     .map((subject) => {
                       ...
                       let modifiedSubject = { ...subject };
                         ...
                         <SubjectCard
                           ...
                           lastActivity={getLastActivity(subject.id)}
                           userId={user?.id}
                           onToggleUserSubject={subject.id === 'physics-edexcel' ? handlePhysicsToggle : toggleUserSubject}
                           isUserSubject={userSubjects.includes(subject.id)}
                           showAddButton={subjectsTab === 'all-subjects'}
                         />
                         );
        ...
        {showStreakCelebration && (
          <StreakCelebration 
            ...
            rewardText="Amazing consistency!"
            rewardEmoji="🔥"
