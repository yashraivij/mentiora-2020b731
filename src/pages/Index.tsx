...
import { BookOpen, Target, TrendingUp, Trophy, ArrowRight, Star, Play, Zap, Brain, Users, CheckCircle, Sparkles } from "lucide-react";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
        ...
        <header className="flex flex-col sm:flex-row justify-between items-center mb-16 lg:mb-20 gap-4">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent tracking-tight">Mentiora</h1>
          </div>
        ...
        <div className="text-center mb-16 lg:mb-24 max-w-4xl mx-auto">
          <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-emerald-100 to-blue-100 border border-emerald-200 rounded-full text-emerald-700 text-sm font-medium mb-8">
          ...
          <Button 
            onClick={() => navigate('/register')} 
            className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 px-8 py-4 text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-200 rounded-xl"
          >
            Start My Revision Journey
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-20 lg:mb-28 max-w-4xl mx-auto">
          {stats.map((stat, index) => (
            <div key={index} className="text-center relative">
              ...
              <div className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-2">{stat.number}</div>
            ...
            {howItWorks.map((step, index) => (
              <div key={index} className="text-center relative">
                {index < howItWorks.length - 1 && (
                  <div className="hidden lg:block absolute top-16 left-full w-full h-0.5 bg-gradient-to-r from-blue-200 to-indigo-200 transform -translate-x-1/2"></div>
                )}
                ...
                <div className="absolute -top-1 -left-1 w-6 h-6 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full flex items-center justify-center text-white text-sm font-bold">
                  {step.step}
                </div>
          ...
          {features.map((feature, index) => (
            <Card key={index} className="p-8 border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-slate-50/50 group">
              <CardContent className="p-0 text-center">
                <div className="w-16 h-16 bg-gradient-to-r from-blue-100 to-indigo-100 border border-blue-200 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {reviews.map((review, index) => (
              <Card key={index} className="p-8 border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-slate-50/50 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-emerald-400 to-green-500 rounded-bl-3xl flex items-center justify-center">
                ...
                <div className="mb-4">
                  ...
                  <div className="border-t border-slate-100 pt-4">
                    ...
                    <div className="text-blue-600 font-medium">{review.grade}</div>
                  </div>
                </div>
              </Card>
            ))}
        ...
        {/* Premium CTA */}
        <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-3xl p-12 lg:p-16 text-center text-white max-w-4xl mx-auto shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <Button 
              onClick={() => navigate('/register')} 
              className="bg-white text-blue-600 hover:bg-slate-100 px-8 py-4 text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-200 rounded-xl"
            >
              Start My Revision Journey
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
