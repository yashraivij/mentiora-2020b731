...
const Index = () => {
  ...
  const stats = [
    { number: "1000+", label: "Practice Questions", gradient: "from-blue-600 to-cyan-600" },
    { number: "< 3 sec", label: "AI Response Time", gradient: "from-purple-600 to-pink-600" },
    { number: "3", label: "Core GCSE Subjects", gradient: "from-emerald-600 to-teal-600" },
    { number: "100%", label: "Free Access", gradient: "from-orange-600 to-red-600" }
  ];

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-gradient-to-br from-indigo-50/50 via-purple-50/30 to-pink-50/20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
        ...
        <header className="flex flex-col sm:flex-row justify-between items-center mb-16 lg:mb-20 gap-4">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-3xl font-bold bg-gradient-to-r from-slate-900 via-indigo-800 to-purple-800 bg-clip-text text-transparent tracking-tight">Mentiora</h1>
          </div>
          <div className="flex gap-3">
            {user ? (
              <Button 
                ...
                size="lg"
                className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700 text-white font-semibold px-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 rounded-xl"
              >
                Enter Dashboard
              </Button>
            ) : (
              <>
                <Button 
                  ...
                  className="text-slate-700 hover:text-slate-900 hover:bg-gradient-to-r hover:from-slate-100 hover:to-indigo-100 font-semibold border border-slate-200 hover:border-indigo-300 transition-all duration-200 rounded-xl"
                >
                  Sign In
                </Button>
                <Button 
        ...
        <div className="text-center mb-16 lg:mb-24 max-w-4xl mx-auto">
          <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50 border-2 border-gradient-to-r from-indigo-200 via-purple-200 to-pink-200 rounded-full text-indigo-700 text-sm font-semibold mb-8 shadow-sm">
          ...
          <Button 
            onClick={() => navigate('/register')} 
            size="lg"
            className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700 text-white px-10 py-4 text-xl font-bold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 rounded-2xl"
          >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-20 lg:mb-24 max-w-4xl mx-auto">
          {stats.map((stat, index) => (
            <div key={index} className="text-center bg-white/70 backdrop-blur-sm rounded-2xl p-6 border-2 border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-indigo-300">
              <div className={`text-3xl lg:text-4xl font-bold bg-gradient-to-r ${stat.gradient} bg-clip-text text-transparent mb-2`}>{stat.number}</div>
        ...
        <div className="mb-20 lg:mb-24">
          <div className="text-center mb-16">
            <h3 className="text-4xl lg:text-5xl font-bold mb-6 tracking-tight">
              <span className="bg-gradient-to-r from-slate-900 via-indigo-800 to-purple-800 bg-clip-text text-transparent">How It Works</span>
            </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {howItWorks.map((step, index) => (
              <div key={index} className="text-center group">
                <div className={`w-20 h-20 bg-gradient-to-br ${step.gradient} rounded-3xl flex items-center justify-center mb-6 shadow-lg mx-auto group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="mb-20 lg:mb-24">
          <div className="text-center mb-16">
            <h3 className="text-4xl lg:text-5xl font-bold mb-6 tracking-tight">
              <span className="bg-gradient-to-r from-slate-900 via-indigo-800 to-purple-800 bg-clip-text text-transparent">Why Top Students Choose Mentiora</span>
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {features.map((feature, index) => (
              <Card key={index} className={`p-8 border-2 border-slate-200 shadow-xl hover:shadow-2xl transition-all duration-300 bg-gradient-to-br ${feature.cardGradient} hover:border-indigo-300 group rounded-2xl hover:-translate-y-1`}>
        ...
        <div className="mb-20 lg:mb-24">
          <div className="text-center mb-16">
            <h3 className="text-4xl lg:text-5xl font-bold mb-6 tracking-tight">
              <span className="bg-gradient-to-r from-slate-900 via-indigo-800 to-purple-800 bg-clip-text text-transparent">Real Results, Real Success</span>
            </h3>
            <p className="text-xl text-slate-600">Join students already achieving their highest grades</p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {testimonials.map((review, index) => (
              <Card key={index} className={`p-8 border-2 border-slate-200 shadow-xl hover:shadow-2xl transition-all duration-300 bg-gradient-to-br ${review.cardGradient} rounded-2xl hover:-translate-y-1`}>
                <CardContent className="p-0">
                  ...
                  <div className="border-t border-slate-200 pt-4">
                    ...
                    <div className={`${review.accentColor} font-semibold`}>{review.grade}</div>
                  </div>
                </CardContent>
              </Card>
            ))}
        ...
        {/* Premium CTA */}
        <div className="bg-gradient-to-r from-slate-900 via-indigo-900 via-purple-900 to-pink-900 rounded-3xl p-12 lg:p-16 text-center text-white max-w-4xl mx-auto shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <Button 
              onClick={() => navigate('/register')} 
              size="lg"
              className="bg-white text-slate-900 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 px-10 py-4 text-xl font-bold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 rounded-2xl"
            >
              Personalise My Revision
