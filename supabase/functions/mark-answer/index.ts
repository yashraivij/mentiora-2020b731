...
5. MATHEMATICAL ACCURACY: 
   ...
   - Only deduct marks if working is COMPLETELY missing when explicitly required by the question, OR if the working contains mathematical errors
